...
export class RoiComponent implements OnInit, OnDestroy {
  ...
  public texts = {
    ...
    ar: {
      ...
      subtitle: 'تعرف كيف يترجم تحسين أداء المسوقين والمشرفين إلى وفورات مالية ملموسة وقيمة تشغيلية حقيقية.',
      fieldReps: 'عدد المسوقين الميدانيين',
      supervisors: 'عدد المشرفين الميدانيين',
      branches: 'عدد الفروع/المناطق',
      monthlyVisits: 'الزيارات الشهرية لكل مسوق',
      repSalary: 'متوسط راتب المسوق الشهري (ريال)',
